 ...
 *  
 *  Editted by David Jon (2015) (http://www.stylique.nl). Now resizing an image based on an attachment ID, not based on an url. 
...
function stylique_image_resizer( $id = false, $width = NULL, $height = NULL, $crop = true, $retina = false, $array = false) {

		global $wpdb;
		if ( empty( $id ) )
			
			return 'http://www.lorempixel.com/'.$width.'/'.$height.'/';
